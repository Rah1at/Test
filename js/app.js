...
function wd_cookie_policy(lang) {
	...
	if (policy!=null && policy!="") {
		...
		if(lang == 'pl') {
			var text = 'Ta strona wykorzystuje ciasteczka (ang. cookies). Korzystanie z naszego serwisu bez zmiany ustawień dotyczących cookies oznacza, że będą one zapisane w pamięci urządzenia. Więcej w <a href="../../doc/polityka_prywatnosci.pdf" target="_blank">Polityce prywatności.</a>';
		}
		else if(lang == 'en') {
